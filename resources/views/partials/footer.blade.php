<footer class="bg-gray-900 dark:bg-gray-900 px-0 lg:px-10 font-jost w-full">
    {{-- <div class="max-w-screen-xl mx-auto w-full p-4 py-6 lg:py-4">
        <div class="md:flex md:justify-between flex-col md:flex-row">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 me-3" alt="FlowBite Logo" />
                  <span class="text-white self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sigrax</span>
              </a>
          </div>
          <div class="flex lg:grid lg:grid-cols-3 md:gap-5 sm:grid-cols-3">
              <div>
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      <div class="md:flex md:justify-between">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-white">Product</h2>
                <ul class="text-gray-400 dark:text-gray-400 font-medium">
                    <li class="mb-4">
                        <a href="/product-and-features" class="hover:underline">CMMS</a>
                    </li>
                    <li>
                        <a href="/features/cmms-software" class="hover:underline">Modules and Features</a>
                    </li>
                </ul>
            </div>
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-white">Sigrax</h2>
                <ul class="text-gray-400 dark:text-gray-400 font-medium">
                    <li class="mb-4">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-400 sm:text-center dark:text-gray-400">© 2023 <a href="/" class="hover:underline">SIGRAX</a>. All Rights Reserved.
        </span>
    </div>
  </div>
</footer>
