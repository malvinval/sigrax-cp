...
@section("container")
    <div class="hero min-h-screen">
        <div class="flex flex-col lg:flex-row text-gray-800 dark:text-white">
            <div class="flex flex-col flex-grow lg:h-screen text-cente font-jost mx-auto sm:w-full lg:w-1/3 pt-24 lg:pt-28 pb-16 lg:pb-0 bg-gradient-to-b lg:bg-gradient-to-r from-red-500 to-slate-800">
                <img class="pt-8 w-1/2 sm:w-1/4 lg:w-3/4 mx-auto drop-shadow-xl" src="{{ asset('images/sigrax-logo.png') }}" alt="Dashboard">            
            </div>
            <div class="flex flex-col flex-grow lg:h-screen text-left font-jost mx-auto lg:w-1/2 pt-12 lg:pt-48 pb-16 px-10 lg:px-6 bg-white dark:bg-slate-800">
