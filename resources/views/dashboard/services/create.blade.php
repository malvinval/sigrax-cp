...
@section("container")
    ...
    <div class="font-jost ml-0 lg:ml-80 mt-16 lg:mt-24 p-5">
        <h1 class="font-bold text-xl md:text-3xl pb-5">Create new service</h1>

        <form onsubmit="return confirm('Do you really want to publish this service?');" method="POST" action="/dashboard/services" class="w-full lg:w-1/2">
            @csrf
